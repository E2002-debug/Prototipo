...
/proyecto ├── index.html ├── iniciar_sesión/ │ └── code.html ├── registro/ │ └── code.html ├── mascotas/ │ └── agregar.html ├── citas/ │ └── agendar.html └── docs/ ├── ui_prototipo_stitch.md ├── pantalla_login.png ├── pantalla_registro.png ├── pantalla_agendar.png ├── pantalla_exito.png
...
Menú principal → Agregar mascota
Agregar mascota → Confirmación
Menú principal → Agendar cita
...
-Listado de citas -Boton de agregar citas
